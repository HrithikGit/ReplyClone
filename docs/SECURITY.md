...
## AWS Secrets Manager
- Store `WHATSAPP_ACCESS_TOKEN`, `WHATSAPP_VERIFY_TOKEN`, `WHATSAPP_PHONE_NUMBER_ID`, `WHATSAPP_BUSINESS_ACCOUNT_ID`, `META_APP_SECRET`, `ALLOWLIST_NUMBERS`, `DEEPSEEK_API_KEY`, and `SARVAM_API_KEY` there.
